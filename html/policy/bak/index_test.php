...
<div id="contents">
    ...
    <div class="container" id="policy">
		...
		<ul class="list">
			...
			<li>(2) 선택사항 : 회사주소, 회사전화번호, 직업, 회사명, 부서, 직급, 취미, 결혼 여부, 기념일 정보(결혼 기념일, 차량 출고일), 차량 보유 수, 보유 차량정보, 관심사, 선호미티어, 관심모델, 차량 구입시기, 뉴스레터 수신여부, 자주 보는 자동차 잡지, 가입 경로</li>
        ...
        <h5>9. 개인정보의 국외이전</h5>
		<ul class="list">
			<li class="normal">회사는 볼보자동차 본사 주관의 고객만족도 조사를 위하여 다음의 정보를 제공합니다.
				<div class="table_wrap" >
		...
		<ul class="list">
			...
			<li class="normal">공고일자 : 2020년 8월 5일<br>
                시행일자 : 2020년 8월 5일<br>
				최종 수정일자 : 2020년 8월 5일<br>
			</li>
		</ul>
