    ...
    <div class="container">
		<div class="slide_wrap" style="width:100%; height:100%;">
			...
			<div class="slide_sub slide_02">
				<div class="cont_wrap">
					<div class="ti">THE SMARTEST EVER</div>
					<div class="txt">XC60은 역동적인 느낌의 중형 SUV 로 새로운 디자인 디테일과 SKT 인포테인먼트 서비스가 탑재되어 더 스마트해졌습니다.</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
			...
			<div class="slide_sub slide_04">
				<div class="cont_wrap">
					...
					<div class="txt">Bowers&Wilkins 고급 사운드 시스템을 통해 하이엔드 오디오의 성능을 즐길 수 있습니다. (Inscription)</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
			<div class="slide_sub slide_05">
				<div class="cont_wrap">
					<div class="sti"> </div>
					<div class="ti">The new XC60</div>
					<div class="img"><img src="/images/cars/xc60/2021_09/slide_05.png"></div>
					<ul class="btns">
						<li class="btn"><a href="javascript:open_pop('spec');">Specifications <span>></span></a></li>
						<li class="btn"><a href="javascript:open_pop('option');">Options <span>></span></a></li>
						<li class="btn"><a href="javascript:open_pop('price');">Price List <span>></span></a></li>
				...
				<div class="spec_list">
					...
					<ul>
						<li>
							...
							<div class="list_val">18" 5 l 235 / 60R18</div>
						</li>
						<li>
							<div class="list_name"><span>Inscription</span></div>
							<div class="list_val">19" 5 l 235 / 55R19</div>
						</li>
					</ul>
				</div>
				<div class="spec_list">
			...
			<div class="spec_cont spec_cont_03" style="display:none;">
				...
				<div class="spec_list">
					...
					<ul>
						<li>
							...
							<div class="list_val">21" 5 l 255 / 40R21</div>
						</li>
						<li>
							<div class="list_name"><span>Inscription</span></div>
							<div class="list_val">20" 5 l 255 / 45R20</div>
						</li>
					</ul>
				</div>
				<div class="spec_list">
				...
				<div class="spec_list">
					...
					<ul>
						...
						<li>
							<div class="list_name">정부 공인 표준 연비(도심)<span>(km/ℓ)</span></div>
							<div class="list_val">8.1</div>
						</li>
						<li>
							<div class="list_name">정부 공인 표준 연비(고속도로)<span>(km/ℓ)</span></div>
							<div class="list_val">10.7</div>
						</li>
						<li>
							<div class="list_name">에너지소비효율등급<span>(등급)</span></div>
		...
		<div class="pop_cont pop_option" style="display:none;">
			...
			<div class="options_tab_wrap list_swiper">
				<ul class="options_tab">
					...
					<li><a href="javascript:options_tab(3);">B6 AWD R-Design</a></li>
					<li><a href="javascript:options_tab(4);">B6 AWD Inscription</a></li>
					<li><a href="javascript:options_tab(5);">T8 AWD Inscription</a></li>
				</ul>
			</div>
			<div class="options_img">
				<div class="options_img_01"><img src="/images/cars/xc60/2021_09/options_car_img_01.png"></div>
				<div class="options_img_02" style="display:none"><img src="/images/cars/xc60/2021_09/options_car_img_02.png"></div>
				<div class="options_img_03" style="display:none"><img src="/images/cars/xc60/2021_09/options_car_img_03.png"></div>
				<div class="options_img_04" style="display:none"><img src="/images/cars/xc60/2021_09/options_car_img_04.png"></div>
				<div class="options_img_05" style="display:none"><img src="/images/cars/xc60/2021_09/options_car_img_05.png"></div>
			</div>
			...
			<div class="options_detail detail_01"><!--B5 mmt-->
				<ul>
					...
					<li class="txt wheel_ti">18" 5-더블 스포크 블랙 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/xc60/2021_09/wheel_b5_mmt.png"></div>					
					</li>
				</ul>
				<ul>
				...
				<ul>
					...
					<li class="txt">블랙 인티그레이티드 루프 레일</li>
				</ul>
				<ul>
			...
			<div class="options_detail detail_02" style="display:none"><!--B5 Ins-->
				<ul>
					...
					<li class="txt wheel_ti">19" 5-멀티 스포크 블랙 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/xc60/2021_09/wheel_b5_ins.png"></div>					
					</li>
				</ul>
				<ul>
					<li class="ti">SAFETY & SUPPORT SYSTEM</li>
					<li class="txt">전방 충돌 경보 및 긴급제동 서포트	
					<li class="txt">차선 유지 보조</li>	
					<li class="txt">거리 경보</li>	
					<li class="txt">운전자 경보 제어</li>	
					<li class="txt">도로 이탈 방지 및 보호</li>	
			...
			<div class="options_detail detail_03" style="display:none"><!--B6 Ins-->
				<ul>
					<li class="ti">WHEELS & TIRES</li>
					<li class="txt wheel_ti">21" 5-더블 스포크 블랙 다이아몬드 컷  
						<div class="wheel_image"><img src="/images/cars/xc60/2021_09/wheel_b6_rdg.png"></div>						
					</li>
				</ul>
				<ul>
					<li class="ti">SAFETY & SUPPORT SYSTEM</li>
				...
				<ul>
					...
					<li class="txt">눈부심 방지 룸 미러 & 아웃사이드 미러</li>	
					<li class="txt">컬러 코디네이티드 도어 핸들</li>
					<li class="txt">R-design 그릴 및 블랙 사이드 미러 커버</li>
					<li class="txt">블랙 데코 사이드 윈도</li>
					<li class="txt">블랙 인티그레이티드 루프 레일</li>
				</ul>
				<ul>
					<li class="ti">INTERIOR & SEATS</li>
					<li class="txt">3-스포크 유니 데코 인레이 스포츠 스티어링 휠</li>
					<li class="txt">스티어링 휠 히팅</li>
					<li class="txt">나파가죽 시트</li>	
					<li class="txt">앞좌석 전동 시트 및 메모리 기능</li>	
					<li class="txt">앞좌석 전동 럼버 서포트</li>	
			...
			<div class="options_detail detail_04" style="display:none"><!--T8 Inscription-->
				<ul>
					<li class="ti">WHEELS & TIRES</li>
					<li class="txt wheel_ti">20" 5-Y 스포크 그라파이트 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/xc60/2021_09/wheel_b6_ins.png"></div>					
					</li>
				</ul>
				<ul>
					<li class="ti">SAFETY & SUPPORT SYSTEM</li>
			...
			<div class="options_detail detail_05" style="display:none"><!--T8 Inscription-->
				<ul>
					<li class="ti">WHEELS & TIRES</li>
					<li class="txt wheel_ti">20" 5-Y 스포크 그라파이트 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/xc60/2021_09/wheel_b6_ins.png"></div>					
		...
		<div class="pop_cont pop_price" style="display:none;">
			...
			<ul	class="model_list">
				<li class="list list_03">
					...
					<div class="list_img"><img src="/images/cars/xc60/2021_09/price_car_img_01.png"></div>
				...
				<li class="list list_04">
					...
					<div class="list_img"><img src="/images/cars/xc60/2021_09/price_car_img_02.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
				...
				<li class="list list_05">
					...
					<div class="list_img"><img src="/images/cars/xc60/2021_09/price_car_img_03.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
				...
				<li class="list list_02">
					<div class="list_title">INSCRIPTION</div>
					<div class="list_img"><img src="/images/cars/xc60/2021_09/price_car_img_04.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
				...
				<li class="list list_02">
					<div class="list_title">INSCRIPTION</div>
					<div class="list_img"><img src="/images/cars/xc60/2021_09/price_car_img_05.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
