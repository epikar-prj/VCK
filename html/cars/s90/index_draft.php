				...
				<div class="spec_list">
					...
					<ul>
						...
						<li>
							...
							<div class="list_val">엔진 : 250 / 5,400 ~ 5,700<span class="list_val_inner">모터 : 10kW / 3,000rpm</span></div>
						</li>
						<li>
			...
			<div class="spec_cont spec_cont_02" style="display:none;">
				...
				<div class="spec_list">
					...
					<ul>
						...
						<li>
							<div class="list_name">마력<span>(ps/rpm)</span></div>
							<div class="list_val">엔진 : 318 / 6,000<span class="list_val_inner">모터 : 87 / 7,000<br>(65kw 환산 시)</span></div>
						</li>
						<li>
							<div class="list_name">토크<span>(kg·m/rpm)</span></div>
