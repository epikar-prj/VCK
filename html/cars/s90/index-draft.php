		...
		<div class="slide_wrap" style="width:100%; height:100%;">
			<div class="slide_main slide_01">
				<div class="cont_wrap">
					...
					<ul class="btn_wrap">
						...
						<li class="btn vbs"><a href="https://www.volvocars.com/kr/build/s/s90" target="_blank">VBS<span>></span></a></li>
					</ul>
			...
			<div class="slide_sub slide_02">
				<div class="cont_wrap">
					...
					<div class="txt">S90은 우아하고 아름답게 꾸며진 스칸디나비안 디자인과 혁신 기술로 설계한 최고의 세단입니다.</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
			<div class="slide_sub slide_03">
				<div class="cont_wrap">
					...
					<div class="txt">동급 최장 휠베이스 기반의 넓어진 실내 공간으로 럭셔리 세단의 여유로운 승차감을 완성했습니다.</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
	...
	<div class="pop_wrap" style="display:none;">
			...
			<div class="spec_cont spec_cont_01">
				...
				<div class="spec_list">
					...
					<ul>
						...
						<li>
							<div class="list_name">마력<span>엔진(ps/rpm)</span></div>
							<div class="list_val">250/5,400 ~ 5,700</div>
						</li>
						<li>
							<div class="list_name"><span>모터(ps/rpm)</span></div>
							<div class="list_val">14/3,000(10kw 환산 시)</div>
						</li>
						<li>
							<div class="list_name">토크<span>엔진(kg·m/rpm)</span></div>
							<div class="list_val">35.7/1,800 ~ 4,800</div>
						</li>
						<li>
							<div class="list_name"><span>모터(kg·m/rpm)</span></div>
							<div class="list_val">4.1/2,250</div>
						</li>
						<li>
			...
			<div class="spec_cont spec_cont_02" style="display:none;">
				...
				<div class="spec_list">
					...
					<ul>
						...
						<li>
							<div class="list_name"><span>모터(ps/rpm)</span></div>
							<div class="list_val">87/7,000(65kw 환산 시)</div>
						</li>
						<li>
							<div class="list_name">토크<span>엔진(kg·m/rpm)</span></div>
		...
		<div class="pop_cont pop_option" style="display:none;">
			...
			<div class="options_img">
				<div class="options_img_01"><img src="/images/cars/s90/options_car_img_01_new.png"></div>
				<div class="options_img_02" style="display:none"><img src="/images/cars/s90/options_car_img_02_new.png"></div>
				<div class="options_img_03" style="display:none"><img src="/images/cars/s90/options_car_img_03_new.png"></div>
			</div>
			<div class="options_detail detail_01">
				<ul>
					<li class="ti">WHEELS & TIRES</li>
					<li class="txt wheel_ti">18” 10-스포크 터빈 실버 브라이트
						<div class="wheel_image"><img src="/images/cars/s90/wheel_01.png"></div>					
					</li>
				</ul>
				<ul>
			...
			<div class="options_detail detail_02" style="display:none">
				<ul>
					...
					<li class="txt wheel_ti">19” 10-스포크 블랙 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/s90/wheel_02.png"></div>					
					</li>
				</ul>
				<ul>
					<li class="ti">SAFETY & SUPPORT SYSTEM</li>
			...
			<div class="options_detail detail_03" style="display:none">
				<ul>
					...
					<li class="txt wheel_ti">20”  8-멀티 스포크 블랙 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/s90/wheel_03.png"></div>					
					</li>
				</ul>
				<ul>
					<li class="ti">SAFETY & SUPPORT SYSTEM</li>
		...
		<div class="pop_cont pop_price" style="display:none;">
			...
			<ul	class="model_list">
				<li class="list list_01">
					...
					<div class="list_img"><img src="/images/cars/s90/price_car_img_01_new.png"></div>
				...
				<li class="list list_02">
					...
					<div class="list_img"><img src="/images/cars/s90/price_car_img_02_new.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
				...
				<li class="list list_03">
					<div class="list_title">INSCRIPTION</div>
					<div class="list_img"><img src="/images/cars/s90/price_car_img_03_new.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
