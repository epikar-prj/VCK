    ...
    <div class="container">
		<div class="slide_wrap" style="width:100%; height:100%;">
			<div class="slide_main slide_01">
				<div class="cont_wrap">
					...
					<ul class="btn_wrap">
						...
						<li class="btn vbs"><a href="https://www.volvocars.com/kr/build/v/v60" target="_blank">Build<span>></span></a></li>
					</ul>
			...
			<div class="slide_sub slide_02">
				<div class="cont_wrap">
					<div class="ti">MAKE AN IMPRESSION</div>
					<div class="txt">견고하면서도 우아한 스칸디나비아 디자인은 도시 중심에서나 인적이 끊긴 곳 그 어디에서도 탁월함이 돋보입니다.</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
			<div class="slide_sub slide_03">
				<div class="cont_wrap">
					<div class="ti">MASTER ANY ROAD</div>
					<div class="txt">모험이 이루어지는 곳이라면 어디든 운전자 지원 기술과 첨단 4륜 구동으로 대부분의 도로 조건에서 반응성이 뛰어난 드라이빙 체감을 구현해 줍니다.</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
			<div class="slide_sub slide_04">
				<div class="cont_wrap">
					<div class="ti">OPEN SKIES</div>
					<div class="txt">오픈-앤-틸트 파노라마 루프를 통해 멋진 실외와 실내 사이의 경계를 희미하게 하고, 상쾌한 공기와 탁 트인 하늘을 즐길 수 있습니다.</div>
					<div class="btn_next"><a href="javascript:next_page();">Read More</a></div>
				</div>
			</div>
			<div class="slide_sub slide_05">
				<div class="cont_wrap">
					<div class="sti"> </div>
					<div class="ti">Cross Country (V60)</div>
					<div class="img"><img src="/images/cars/v60/2021_10/slide_05.png"></div>
					<ul class="btns">
						<li class="btn"><a href="javascript:open_pop('spec');">Specifications <span>></span></a></li>
						<li class="btn"><a href="javascript:open_pop('option');">Options <span>></span></a></li>
						<li class="btn"><a href="javascript:open_pop('price');">Price List <span>></span></a></li>
					</ul>
					<div class="btn_link"><a href="https://www.volvocars.com/kr/cars/new-models/the-new-volvo-cross-country" target="_blank">자세히 보기 <span>></span></a></div>
				</div>
			</div><!--slide_05_end-->
		</div>
    </div>
	...
	<div class="pop_wrap" style="display:none;">
				...
				<div class="spec_list">
					...
					<ul>
						<li>
							...
							<div class="list_val">18” 5 l 215 / 55R18</div>
						</li>
						<li>
							<div class="list_name"><span>Cross Country Pro</span></div>
							<div class="list_val">19” 5 l 235 / 45R19</div>
						</li>
					</ul>
				</div>
				<div class="spec_list">
		...
		<div class="pop_cont pop_option" style="display:none;">
			...
			<div class="options_img">
				<div class="options_img_01"><img src="/images/cars/v60/2021_10/options_car_img_01.png"></div>
				<div class="options_img_02" style="display:none;"><img src="/images/cars/v60/2021_10/options_car_img_02.png"></div> 
			</div>
			<div class="options_detail detail_01">
				<ul>
					<li class="ti">WHEELS & TIRES</li>
					<li class="txt wheel_ti">18” 5-스포크 블랙 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/v60/2021_10/wheel_01.png"></div>					
					</li>
				</ul>
				<ul>
			...
			<div class="options_detail detail_02" style="display:none">
				<ul>
					...
					<li class="txt wheel_ti">19” 5-더블 스포크 블랙 다이아몬드 컷
						<div class="wheel_image"><img src="/images/cars/v60/2021_10/wheel_02.png"></div>	
					</li>
				</ul>
				<ul>
					<li class="ti">SAFETY & SUPPORT SYSTEM</li>
		...
		<div class="pop_cont pop_price" style="display:none;">
			...
			<ul	class="model_list">
				<li class="list list_01">
					...
					<div class="list_img"><img src="/images/cars/v60/2021_10/price_car_img_01.png"></div>
				...
				<li class="list list_01">
					...
					<div class="list_img"><img src="/images/cars/v60/2021_10/price_car_img_02.png"></div>
					<ul class="price_title">
						<li>ENGINE</li>
						<li>MSRP</li>
					</ul>
