...
<link rel="stylesheet" href="/html/member/swiper.css">
    <div id="contents">
        ...
        <div class="container">
			...
			<form name="resvtForm" method="GET" action="/html/rt_reservation/reservation1.php" onsubmit="return checkValidate(this);">
				...
				<div class="phone_col">
					<div class="input_wrap phone_wrap">
                        ...
                        <input type="hidden" name="resvt_tel" value="<?$hp[0] . $hp[1] . $hp[2]?>">
					</div>
				</div>					
...
function checkValidate(f) {
    ...
    f.resvt_tel.value = f.hp1.value + "" + f.hp2.value + "" + f.hp3.value;
...
//             resvt_tel: f.hp.value + f.hp2.value + f.hp3.value,
