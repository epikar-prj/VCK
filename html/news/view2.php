...
$sql = " SELECT title, publish_date, thum_file, content FROM volvo_bbs_{$bm_sid} WHERE sid = '{$sid}' ";
    ...
    <div id="contents" class="newsview2">
        ...
        <div class="container">
            <div class="view">
                ...
                <h6><span class="date"><?=$row['publish_date']?></span></h6>
                <div class="cont">
                    <?=$row['content']?>
                </div>
                <!--<div class="btn_close">
