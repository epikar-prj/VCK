    ...
    <div class="container">
		<div class="join">
			<form name="joinForm" method="POST" action="join_update.php" onsubmit="return check_validate(this);">
                ...
                <input type="hidden" name="certi" value="">
                <input type="hidden" name="user_id" value="">
                
                <strong class="input_tit">ID (E-mail)</strong>
				<div class="input_wrap email_wrap">
					<div class="input_box">
						<input type="text" name="email1" id="email1" value="<?=$email?>" onkeydown="keyDown(event)" autocapitalize="off" autocorrect="off" placeholder="example">
				...
				<div id="email_self" class="input_wrap email_select_wrap" style="display: none;">
                    <div class="input_box">
                        <input type="text" name="email_self" id="email_self_input" value="<?=$email?>" onkeydown="keyDown(event)" autocapitalize="off" autocorrect="off" placeholder="volvo.com">
                    </div>
				</div>
...
<script>
	$(window).on('load',function(){
        ...
        $("#email_self_input").on("blur", function() {
            if ($('#selectEmail').val() == "self") {
    ...
    function check_validate(f) {
        ...
        var email1 = f.email1.value .replace(/(\s*)/g, "");
        var email2 = f.email2.value .replace(/(\s*)/g, "");
