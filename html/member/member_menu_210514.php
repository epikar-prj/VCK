<?
	...
	// 가짜 데이터
	$fakeDate = array("2019-01-01", "2018-01-01", "2019-03-01", "2019-02-01", "2019-01-01");
    ...
    <div class="container">
		<div class="member_menu">
			...
			<ul>
                ...
                if ($_COOKIE['master_cust_cd'] == '2356046') {
                    $_COOKIE['master_cust_cd'] = '2382717';
                }
                echo $_COOKIE['master_cust_cd'];
                // 대기고객 체크                
