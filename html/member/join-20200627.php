...
<div id="contents">
    ...
    <div class="container">
		<div class="join">
			<form method="POST" action="join_update.php" onsubmit="return check_validate(this);">
                ...
                <div class="input_wrap car_number_wrap2">
                    <label for="car_no"><input id="car_no" name="member_type" type="radio" value="own" checked><span>소유</span></label>
                    <label for="vehicle_no"><input id="vehicle_no" name="member_type" type="radio" value="wanna"><span>미소유</span></label>
                </div>
				...
				<div class="phone_row">
                    <div class="phone_col">
                        <div class="input_wrap phone_wrap">
                            ...
                            <div class="input_box">
                                <input type="text" name="hp2" value="<?=$hp2?>" placeholder="1234">
                            </div>
                            <div class="input_box">
                                <input type="text" name="hp3" value="<?=$hp3?>" placeholder="1234">
                            </div>
                        </div>
                       <!-- <a href="/plugin/certification/kmcis_web_sample_step01.php" class="btn phone_certification">휴대폰 인증</a>-->
                    </div>
                    <!--<div class="phone_col">
                        <div class="input_wrap phone_wrap">
                            <div class="input_box">
                ...
                <div class="input_wrap car_number_wrap2">
                    <label for="car_no"><input id="car_no" name="car_type" type="radio" value="1" checked><span>차량번호</span></label>
                    <label for="vehicle_no"><input id="vehicle_no" name="car_type" type="radio" value="2"><span>차대번호</span></label>
                </div>
