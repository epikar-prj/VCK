...
<html>
    ...
    <body bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            ...
            <form name="reqForm" method="post" action="https://www.volvoapp.co.kr/plugin/certification/kmcis_web_sample_step02.php">
                <table cellpadding=1 cellspacing=1>
                    ...
                    <tr>
						...
						<input type="radio" name="phoneCorp" id="radio" value="LGM"> LGU+mvno</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="tr_url" size="41" value="https://www.volvoapp.co.kr/plugin/certification/kmcis_web_sample_step03.php"></td>
                    </tr>
                    <tr>
