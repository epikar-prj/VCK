...
// 총 갯수 검색
$query_cnt = "SELECT COUNT(*) cnt FROM volvo_event_1 {$SearchText}";
		...
		<table class="table vt-table bottom-margin">
			...
			<tbody>
				<tr>
					...
					<th scope="col" class="vt-table-th">답</th>
					<th scope="col" class="vt-table-th">휴대전화</th>
					<th scope="col" class="vt-table-th">SMS</th>
					<th scope="col" class="vt-table-th">EMAIL</th>
					<th scope="col" class="vt-table-th">PUSH</th>
					<th scope="col" class="vt-table-th">DM</th>
				...
				<tr>
					...
					<td class="vt-table-td center"><?=$row['answer']?></td>
					<td class="vt-table-td center"><?=$row['hp']?></td>
					<td class="vt-table-td center"><?=$row['use_sms_recept_yn']?></td>
					<td class="vt-table-td center"><?=$row['use_email_recept_yn']?></td>
					<td class="vt-table-td center"><?=$row['use_push_recept_yn']?></td>
					<td class="vt-table-td center"><?=$row['use_dm_recept_yn']?></td>
